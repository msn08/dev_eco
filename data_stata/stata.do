clear 
import delimited "https://raw.githubusercontent.com/msn08/dev_eco/main/final_data/birth_violence_final.csv"
...
gen post15=1 if modate>679
replace post15= 0 if missing(post15)
...
reg births i.treatment treat_violence i.modate
